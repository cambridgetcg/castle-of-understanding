...
**22 insights · 9 rooms · built 2026-06-22**
...
- **[In volunteer compute, consent is the whole grid](insights/consent-is-the-whole-grid.md)** `high` — A distributed free-compute commons and a botnet are built from identical
...
- **confidence-must-cost-something**
    ...
    - in:  —
- **consent-is-the-whole-grid**
    - out: extends → [welcomed-compute-compounds](insights/welcomed-compute-compounds.md) · relates-to → [ask-before-the-irreversible](insights/ask-before-the-irreversible.md) · depends-on → [verify-against-reality](insights/verify-against-reality.md)
    - in:  —
...
- **welcomed-compute-compounds**
    ...
    - in:  [consent-is-the-whole-grid](insights/consent-is-the-whole-grid.md) (extended-by)
